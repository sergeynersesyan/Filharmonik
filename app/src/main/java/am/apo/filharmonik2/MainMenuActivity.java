...
public class MainMenuActivity extends ApoFullScreenActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ticketsButton = (ImageButton) findViewById(R.id.tickets_button);
        requestTicketsUrl();
    ...
    private void requestTicketsUrl() {
        @SuppressLint("StaticFieldLeak") AsyncTask<Void, Void, String> getUrlTask = new AsyncTask<Void, Void, String>() {
            @Override
            protected String doInBackground(Void... params) {
                String ticketsURL = "https://www.tomsarkgh.am";
                try {
                    URL url = new URL("http://apo.am/link/link.txt");

                    BufferedReader reader = new BufferedReader(new InputStreamReader(url.openStream()));
//                    Response response = gson.fromJson(reader, Response.class);
//                    ticketsURL = .articlesResponse.getArticles();
                    String line;
            ...
            @Override
            protected void onPostExecute(final String ticketsURL) {
                super.onPostExecute(ticketsURL);
                ticketsButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        browserIntent.putExtra(getString(R.string.link_url), ticketsURL);
                        browserIntent.putExtra(getString(R.string.link_title), "Filharmonik tickets");
